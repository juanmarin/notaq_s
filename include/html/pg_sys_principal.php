...
<tbody>
	...
	$sql = "SELECT clientes.id, clientes.nombre, clientes.apellidop, clientes.apellidom, cuentas.cantidad FROM clientes, cuentas WHERE clientes.id = cuentas.cliente AND cuentas.estado = 0 ORDER BY clientes.id ASC";
	$res = $db->query($sql);
