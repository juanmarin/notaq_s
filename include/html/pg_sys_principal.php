		...
		<tr>
			<td>
	 		...
	 		<select name="filtromapas" id="filtromapas">
				...
				<option value="5" style="background:#0066CC;">CLIENTES DEL D�A DE HOY</option>
				<option value="1" style="background:#4acc66;">CLIENTES DE 1 A 7 D�AS VENCIDOS</option>
				<option value="2" style="background:#f3ce2e;">CLIENTES DE 8 A 30 D�AS VENCIDOS</option>
				<option value="3" style="background:#ce1818;">CLIENTES DE 31 A 60 D�AS VENCIDOS</option>
				<option value="4" style="background:#a020f0;">CLIENTES DE MAS DE 61 D�AS VENCIDOS</option>
	 		</select>
	 		</td>
	 	</tr>
	 	<?php
