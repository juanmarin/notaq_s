...
<tbody>
	...
	while ($ln = $db->fetchNextObject($result))
	{
		...
		<tr>
			<th>Direcci&oacute;n: </th><td><?= $ln->direccion;?></td>
		</tr>
		<tr>
			<th>Colonia: </th><td><?= $ln->colonia;?></td>
		</tr>
		<tr>
		...
		<tr>
			<th>Direcci&oacute;n: </th><td><?= $ln->edireccion;?></td>
		</tr>
		<tr>
			<th>Colonia: </th><td><?= $ln->ecolonia;?></td>
		</tr>
		<tr>
