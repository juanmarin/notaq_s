...
?>
		...
		<th width="250px" style="text-align: center;"><? echo getFecha($ln->fecha);?></th>
			...
			<th width="250px" style="text-align: center;"><?echo "&#36;"; echo $ln->sumatoria;?></th>
	...
	<tr>
		...
		<th colspan="3" style="text-align:center"><?echo "&#36;"; echo $totRecCobrado;?></th>
	</tr>
	</tfoot>
	</table>
	<br /><br /><br /><br /><br />
...
<thead>
	<tr>
		<th colspan="2">Reporte Recargos</th>
	</tr>
</thead>
<tbody>
</tbody>
