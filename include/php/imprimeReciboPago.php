...
$li+=$alto;
printer_draw_text($handle,"La cantidad de: $".getPagoRedondo($pago),0,$li);
$li+=$alto;
printer_draw_text($handle,"Concepto: ABONO (".$numpago."/".$npagos.")",0,$li);
$li+=$alto;
printer_draw_text($handle,"Tipo de pago: ".$tp,0,$li);
$li+=$alto;
printer_draw_text($handle,"Proximo pago: ".$pp,0,$li);
$li+=$alto;
printer_draw_text($handle,"Saldo anterior: $".moneda2($total),0,$li);
$li+=$alto;
printer_draw_text($handle,"Saldo actual: $".moneda2($total - $_POST["pago"]),0,$li);
$li+=$alto;
printer_draw_text($handle,"Ref: ".$c["cliente"]."-".$cta."-".$_POST["pid"],0,$li);
$li+=$alto;
